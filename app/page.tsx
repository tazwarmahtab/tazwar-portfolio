const projects = [
  ...
  },
  {
    ...
    desc: "An operating-system concept for solar and energy operations, bringing monitoring, optimization, workflow automation, and decision intelligence into one system.",
    status: "CONCEPT / ACTIVE DEVELOPMENT",
    stack: "Product systems · Operations · AI workflows",
  },
  {
    no: "03",
...
function ProjectVisual({ no }: { no: string }) {
  return (
    <div className="project-visual" aria-hidden="true">
      <div className="diagram-line" />
      <div className="diagram">
        <div className="diagram-core">{no === "01" ? "AGENT CORE" : no === "02" ? "OPERATIONS" : "TRANSIT"}</div>
      </div>
    </div>
  );
}
    ...
    <main>
      <div className="shell">
        <nav className="nav" aria-label="Main navigation">
          <a className="brand" href="#top">Tazwar Mahtab</a>
        ...
        <section className="hero" id="top">
          <div>
            <div className="kicker">AI AUTOMATION ENGINEER / BUILDER</div>
          ...
          <div className="hero-bottom">
            ...
            <div className="ctas"><a className="button" href="#work">View selected work</a><a className="button" href="#contact">Contact</a></div>
          </div>
        </section>

        <section className="section" aria-label="Capabilities">
          <div className="capabilities">
            {['AI AGENTS','WORKFLOW AUTOMATION','API INTEGRATIONS','SYSTEMS ARCHITECTURE','PRODUCT ENGINEERING'].map(x => <div className="cap" key={x}>{x}</div>)}
          </div>
        </section>
        ...
        <section className="section" id="work">
          ...
          <div className="projects">
            {projects.map(p => <article className="project" key={p.no}>
              ...
              <div><div className="kicker">{p.category}</div><h3 className="project-title">{p.title}</h3><p className="project-desc">{p.desc}</p></div>
              <div className="project-meta"><div>{p.status}</div><br/><div>{p.stack}</div></div>
              <ProjectVisual no={p.no}/>
            </article>)}
          </div>
        </section>
        ...
        <section className="section">
          <div className="system-grid">
            ...
            <div className="system-visual" aria-label="Example system architecture">
              <div className="flow">
                <div className="flow-row"><div className="node">PROBLEM</div><div className="node">USER</div></div>
                <div className="flow-row"><div className="node">ORCHESTRATOR</div><div className="node">AGENT</div></div>
                <div className="flow-row"><div className="node">TOOLS + APIs</div><div className="node">MEMORY</div></div>
                <div className="flow-row"><div className="node">ACTION</div><div className="node">OBSERVABILITY</div></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <div className="stack">
            <div className="stack-item"><div className="stack-label">AI / AGENTS</div><div className="stack-value">LLM systems<br/>Agent orchestration<br/>Tool use<br/>Memory systems</div></div>
            <div className="stack-item"><div className="stack-label">AUTOMATION</div><div className="stack-value">Workflow design<br/>API integrations<br/>n8n</div></div>
            <div className="stack-item"><div className="stack-label">SOFTWARE</div><div className="stack-value">TypeScript<br/>React / Next.js<br/>Git / GitHub</div></div>
            <div className="stack-item"><div className="stack-label">SYSTEMS</div><div className="stack-value">Rust<br/>Tokio / Axum<br/>SQLite / SQLx</div></div>
          </div>
        </section>
        ...
        <section className="contact" id="contact"><div className="kicker">GET IN TOUCH</div><h2>Have a problem worth automating?</h2><div className="ctas"><a className="button" href="mailto:hello@example.com">Email</a><a className="button" href="https://github.com/tazwarmahtab">GitHub</a></div></section>
